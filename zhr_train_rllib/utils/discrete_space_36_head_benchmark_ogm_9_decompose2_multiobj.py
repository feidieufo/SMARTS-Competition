...
OBSERVATION_SPACE = gym.spaces.Dict(
    {
        ...
        # "neighbor": gym.spaces.Box(low=-1e3, high=1e3, shape=(8 * 5,),),
    }
)
...
def reward_adapter(env_obs, env_reward):
    ...
    # return [crash_penalty/200.0, env_reward/200.0, 0.1*center_penalty/200.0]
    return [crash_penalty/200.0, env_reward/200.0]
    # return [env_reward/200.0, center_penalty/200.0]
